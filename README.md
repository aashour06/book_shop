...
🏷️ Get Book Category – Retrieve the category of a given book title.

💰 Get Book Price – Retrieve the price of a given book title.

🧹 Automatic Data Cleaning – Removes missing categories before storing in the database.

🗃️ SQLite Integration – Efficient local storage with sqlite3.
